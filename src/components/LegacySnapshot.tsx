...
const LegacySnapshot: React.FC<LegacySnapshotProps> = ({
  ...
  return (
    isOpen ? (
      <div
        className="fixed inset-0 bg-black/80 backdrop-blur-sm flex justify-center items-center z-[1000] p-4 animate-fade-in"
        onClick={(e) => { if (e.target === e.currentTarget) onClose(); }}
      >
        <div className="bg-bg-dark rounded-xl shadow-2xl border border-box-border flex flex-col items-center max-h-[90vh] overflow-hidden animate-fade-in">
