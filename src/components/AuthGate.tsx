...
const AuthGate: React.FC<AuthGateProps> = ({
  ...
  if (checkEmail) {
    return (
      <div className="flex items-center justify-center min-h-screen p-4">
        <div className="mx-auto w-full max-w-[26rem] card-base p-8 text-center animate-fade-in">
  ...
  if (recoveryMode || passwordUpdated) {
    return (
      <div className="flex items-center justify-center min-h-screen p-4">
        <div className="mx-auto w-full max-w-[26rem] card-base p-6 sm:p-8 animate-fade-in">
    ...
    <div className="flex items-center justify-center min-h-screen p-4">
      <div className="mx-auto w-full max-w-[26rem] card-base p-6 sm:p-8 animate-fade-in">
        ...
        <p className="text-[0.55rem] text-white/20 text-center mt-4">
          ...
          <Link to="/terms" className="text-primary/80 underline-offset-2 hover:text-primary hover:underline">
            Terms of Service
          </Link>
          {" "}and{" "}
          <Link to="/privacy" className="text-primary/80 underline-offset-2 hover:text-primary hover:underline">
            Privacy Policy
          </Link>.
        </p>
      </div>
