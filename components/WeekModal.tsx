            ...
            <div className="flex-1 overflow-y-auto px-6 pb-4">
              ...
              {!hasContent && !speech.isListening && (
                <div className="flex flex-col items-center py-6">
                  <motion.button
                    ...
                    className="w-20 h-20 rounded-full bg-gradient-to-br from-pink-500/20 to-cyan-500/20 border border-pink-500/20 flex items-center justify-center text-3xl shadow-lg"
              ...
              {speech.isListening && (
                <div className="flex flex-col items-center py-6">
                  <motion.button
                    onClick={speech.stop}
                    className="w-20 h-20 rounded-full bg-[#ec4899]/20 border-2 border-[#ec4899] flex items-center justify-center text-3xl shadow-lg shadow-[#ec4899]/30"
