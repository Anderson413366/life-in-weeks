  ...
  return (
    <>
      ...
      <motion.button
        ...
        className={`fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full flex items-center justify-center text-xl shadow-2xl transition-colors
          ${speech.isListening
            ...
            : "bg-primary text-bg-dark shadow-primary/30 hover:bg-primary-dark"
          }`}
      ...
      <AnimatePresence>
        {showPanel && (
          <motion.div
            className="fixed bottom-24 right-6 z-50 w-80 max-w-[calc(100vw-3rem)] glass rounded-xl p-4 shadow-2xl border border-box-border"
